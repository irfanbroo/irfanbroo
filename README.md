...
- 🤠 I’m currently working on **User Friendly Full stack weather fetching android application using firebase and java for backend using llm and fining tuning an ai to predict weather forecast when user does not have an internt**
